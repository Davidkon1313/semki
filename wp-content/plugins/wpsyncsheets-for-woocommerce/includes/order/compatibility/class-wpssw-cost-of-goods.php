...
if ( ! defined( 'ABSPATH' ) ) {
	exit; }
if ( ! class_exists( 'WPSSW_Cost_Of_Goods' ) ) :
	/**
	 * Class WPSSW_Cost_Of_Goods.
	 */
	class WPSSW_Cost_Of_Goods extends WPSSW_Order_Utils {
		/**
		 * Store header list.
		 *
		...
		protected function prepare_headers() {
			self::$wpssw_headers = array( 'Cost of Good' );
		}
		/**
		 * Get Header List.
		 *
		...
		public static function get_header_list( $headers = array() ) {
			if ( ! empty( self::$wpssw_headers ) ) {
				$headers['WPSSW_Cost_Of_Goods'] = self::$wpssw_headers;
			}
			return $headers;
		}
		/**
		...
		public static function prepare_value( $wpssw_headers_name, $wpssw_order, $wpssw_operation, $wpssw_custom_value = array(), $wpssw_product_headers = array() ) {
			...
			foreach ( $wpssw_items as $wpssw_item ) {
				...
				if ( 'Cost of Good' === (string) $wpssw_headers_name ) {
					$wpssw_value[] = wc_get_order_item_meta( $item_id, '_wc_cog_item_cost' );
				}
			}
			return $wpssw_value;
		}
	}
	new WPSSW_Cost_Of_Goods();
endif;
