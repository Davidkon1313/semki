...
namespace OrderSyncWithGoogleSheetForWooCommerce\Appsero;
...
class Client {
	 ...
	 *
	 * @return OrderSyncWithGoogleSheetForWooCommerce\Appsero\Insights
	 */
	...
	public function updater() {
		...
		_deprecated_function( __CLASS__ . '::updater', '2.0', '\OrderSyncWithGoogleSheetForWooCommerce\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

		// initialize the new updater
		if ( method_exists( '\OrderSyncWithGoogleSheetForWooCommerce\Appsero\Updater', 'init' ) ) {
	 ...
	 *
	 * @return OrderSyncWithGoogleSheetForWooCommerce\Appsero\License
	 */
	...
	protected function set_basename_and_slug() {
		if ( strpos( $this->file, WP_CONTENT_DIR . '/themes/' ) === false ) {
			...
			// Replace get_plugin_data with get_file_data for safety
			...
			$this->project_version = $plugin_data['Version'] ?? 'unknown';
			$this->type            = 'plugin';
		} else {
