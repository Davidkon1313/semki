...
<section class="osgsw-wrapper" x-data="setup">
	...
	<?php
	$active_new_user  = get_option('osgsw_new_user_activate_trigger_1_11_4', '0' );
	$already_update   = get_option('osgsw_already_update_trigger_1_11_4', '0' );
	...
	<div class="ssgs_popup-content" @click.away="show_notice_popup_setup = false">
		<div class="profile-section">
			<div class="profile-details">
				...
				<p class="ossgw_extra_class2"><?php esc_html_e('Please make sure that you have updated the Apps Script. Otherwise the plugin functionality may not work properly.','order-sync-with-google-sheets-for-woocommerce'); ?></p>
			</div>
		</div>
