                    ...
                    <div class="comment">
                        <div class="comment__item">
                            ...
                            <div class="comment__body">
                                <p>Оксана</p>
                                <span>Уже кілька разів замовляли насіння соняшника й гарбузове насіння у «Епік Фудс». Якість продукції на найвищому рівні: свіже, чисте, правильно просушене. Помітно, що компанія дбає про те, щоб товар не втрачав своїх властивостей під час транспортування. Асортимент також тішить – є різні сорти та розміри партій, що дає змогу знайти оптимальний варіант під свої потреби. Дуже задоволені співпрацею!</span>
                ...
                <div class="swiper-slide">
                    <div class="comment">
                        <div class="comment__item">
                            ...
                            <div class="comment__body">
                                <p>Антон</p>
                                <span>Вирішили співпрацювати з «Епік Фудс» після рекомендації колег і не пошкодували. Ціни досить конкурентні, а доставка чітко організована. Замовляли одразу велику партію арахісу та насіння соняшника, усе приїхало вчасно та відповідно до замовленої ваги. Приємно вразила зручна комунікація з менеджерами – швидко реагують і дають усі потрібні документи. Рекомендуємо!</span>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/ui/rate.png" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="comment">
                        <div class="comment__item">
                            ...
                            <div class="comment__body">
                                <p>Сергій</p>
                                <span>Наша компанія працює з «Епік Фудс» вже більше року. За цей час жодного разу не було проблем із якістю насіння та дотриманням термінів поставки. Особливо хочеться відзначити клієнтський сервіс: менеджери завжди допоможуть з підбором оптимального товару та нададуть актуальну інформацію щодо залишків на складі. Відчувається, що тут цінують довгострокові відносини з партнерами.</span>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/ui/rate.png" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="comment">
                        <div class="comment__item">
                            ...
                            <div class="comment__body">
                                <p>Аліна</p>
                                <span>Мали кілька специфічних вимог стосовно упаковки та сортування насіння (для подальшого експорту), і «Епік Фудс» повністю пішли назустріч. Гнучкий підхід до клієнта, можливість замовлення різних обсягів, а також швидке реагування на зміни в заявці – усе це дозволило організувати продажі на зовнішні ринки без затримок. Дуже вдячні команді за професіоналізм та розуміння потреб бізнесу.</span>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/ui/rate.png" alt="">
                            </div>
                        </div>
                    </div>
