jQuery(document).ready(function ($) {
    ...
    $("#btn-want-to-coop").click(function () {
        ...
        $('#orderModal input[placeholder="Номер телефону"]').val(phoneNumber);
    });
    ...
    $("#btn-save-agro").click(function () {
        orderInput.value = "Зберігання агропродукції"; // Set text for first button
        openFormModal();
    });
    // orderInput.setAttribute("readonly", true); // Prevent typing in the input

    document.querySelectorAll("#input_name_tel_form").forEach((inputField) => {
